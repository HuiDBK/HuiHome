...
/**
 * Expand input[v-models] with dyanmic type bindings into v-if-else chains
 * Turn this:
 *   <input v-models="data[type]" :type="type">
 * into this:
 *   <input v-if="type === 'checkbox'" type="checkbox" v-models="data[type]">
 *   <input v-else-if="type === 'radio'" type="radio" v-models="data[type]">
 *   <input v-else :type="type" v-models="data[type]">
 */
